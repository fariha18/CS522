...
public class ChatClientActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		destinationAddr = this.findViewById(R.id.destination_addr);
		chatName = this.findViewById(R.id.chat_name);
		messageText = this.findViewById(R.id.message_text);
